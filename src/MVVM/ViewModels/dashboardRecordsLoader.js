...
export async function loadDashboardRecords({ sectionData, sectionList }) {
  ...
  return { enrollments, allStudentsData, periods, periodGrades, combinedAssessmentScoreData, liveStudentGroups, liveAssessmentDefinitions, attemptRows, grantRows, violationRows, classSessions };
}
